...
const CreateChit=()=>{
    ...
    const [chit,setChit]=useState({ChitName:'',StartDate:'',Months:'',Members:'',Template:'',UserId:User._id,EndDate:''});
    ...
    const handleCreate=()=>{
        ...
        axios.post("http://localhost:5001/api/createChit", data)
			.then((res) => {
            ...
            <div className="form-group">
                ...
                />
                 <input
                    ...
                    value={chit.Template}
                />
                <Button variant="outline-info" className="create_button" onClick={handleCreate}>Create Chit</Button>
            </div>
